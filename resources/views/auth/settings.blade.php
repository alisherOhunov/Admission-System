...
@section('title', __('auth.profile_settings_title'))
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('auth.profile_settings_title') }}</h1>
            <p class="mt-2 text-gray-600">{{ __('auth.profile_settings_subtitle') }}</p>
        </div>
                    ...
                    <div id="profile">
                        ...
                        <div class="tab-content bg-white shadow rounded-lg">
                            <div class="px-6 py-4 border-b border-gray-200">
                                <h2 class="text-lg font-semibold text-gray-900">{{ __('auth.profile_info_heading') }}</h2>
                                <p class="mt-1 text-sm text-gray-600">{{ __('auth.profile_info_description') }}</p>
                            </div>

                            <div class="pt-6 px-6 grid grid-cols-2 gap-4">
                                <!-- First Name -->
                                <div>
                                    <label for="first_name" class="block text-sm font-medium text-gray-700">{{ __('auth.first_name') }}</label>
                                ...
                                <!-- Last Name -->
                                <div>
                                    <label for="last_name" class="block text-sm font-medium text-gray-700">{{ __('auth.last_name') }}</label>
