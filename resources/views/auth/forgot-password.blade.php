    ...
    <div class="min-h-screen flex flex-col justify-center py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 sm:mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-6 sm:py-8 px-4 shadow rounded-lg sm:px-10">
                ...
                @if (session('status'))
                    <div class="bg-green-50 border border-green-200 rounded-md p-3 sm:p-4 mb-4">
                        <div class="flex">
                ...
                <form class="space-y-5 sm:space-y-6" action="{{ route('password.email') }}" method="POST">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="email" name="email" type="email" required 
                                ...
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-sm @error('email') border-red-300 @enderror">
                            @error('email')
                    ...
                    <div>
                        <div class="flex justify-center mb-4 sm:space-y-6">
                            {!! app('captcha')->display() !!}
                        </div>
                        <button type="submit" 
