...
<head>
    ...
    <meta name="description" content="Log in to your {{ config('app.name') }} account to access your dashboard, manage your information, and use personalized services.">
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="flex justify-center">
                ...
                <img src="https://admission-demo.myprojects.uz/favicon.ico" alt="Logo"
