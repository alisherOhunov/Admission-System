    ...
    <div class="overflow-x-auto px-3">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-white">
                <tr>
                    <th scope="col" class="px-3 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_applicant') }}</th>
                    <th scope="col" class="px-2 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_level') }}</th>
                    <th scope="col" class="px-2 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_program') }}</th>
                    <th scope="col" class="px-2 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_period') }}</th>
                    <th scope="col" class="px-2 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_country') }}</th>
                    <th scope="col" class="px-2 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_submitted') }}</th>
                    <th scope="col" class="px-2 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_status') }}</th>
                    <th scope="col" class="px-3 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('admin/index.th_actions') }}</th>
                </tr>
            </thead>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150 text-left">
                        ...
                        <td class="px-2 py-3">
                            ...
                            @if($application->program)
                                <div class="text-xs text-gray-500">{{ $application->program->department }}</div>
                            @endif
                        </td>
                        <td class="px-2 py-3">
                            <div class="text-sm font-medium text-gray-900">
                        ...
                        <td class="px-2 py-3 whitespace-nowrap">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium {{ $statusData['color'] }}  {{ $statusData['bg'] }}">
                                {{ $statusData['label'] }}
                            </span>
                        </td>
                        <td class="px-3 py-3 whitespace-nowrap text-left text-sm font-medium">
                            <div class="flex items-center justify-start space-x-1">
                                <a href="{{ route('admin.applications.show', $application->id) }}" title="{{ __('admin/index.view') }}">
                                    <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-8 rounded-md px-2" aria-label="{{ __('admin/index.view') }}">
                                ...
                                <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-8 rounded-md px-2" title="{{ __('admin/index.more') }}">
