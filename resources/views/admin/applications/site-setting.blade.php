...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ showToast: false }">
        ...
        >
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-gray-900">{{ __('common.success') }}</h3>
                <p class="mt-1 text-sm text-gray-600">{{ __('messages.settings_updated') }}</p>
            </div>
        ...
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('admin/settings.site_settings') }}</h1>
            <p class="mt-2 text-gray-600">{{ __('admin/settings.site_settings_description') }}</p>
        </div>
        ...
        >
            ...
            <div class="bg-white shadow-sm rounded-2xl">
                <div class="p-6">
                    <h2 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('admin/settings.university_information') }}</h2>

                    <div>
                        <label for="university_name" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ __('admin/settings.university_name') }}
                        </label>
                        <input
                            type="text"
                            id="university_name"
                            ...
                            placeholder="{{ __('admin/settings.university_name_placeholder') }}"
                            required
                        >
                        <p class="mt-2 text-sm text-gray-500">
                            {{ __('admin/settings.university_name_description') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-2xl">
                <div class="p-6">
                    <h2 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('admin/settings.help_links') }}</h2>
                    <p class="text-sm text-gray-600 mb-6">{{ __('admin/settings.help_links_description') }}</p>

                    <div class="space-y-4">
                        <!-- Contact Support Link -->
                        <div>
                            <label for="contact_support_link" class="block text-sm font-medium text-gray-700 mb-2">
                                {{ __('admin/settings.contact_support_link') }}
                            </label>
                            <input
                                type="url"
                            ...
                            >
                            <p class="mt-2 text-sm text-gray-500">
                                {{ __('admin/settings.contact_support_link_description') }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <p class="mt-2 text-sm text-gray-500">
                                {{ __('admin/settings.student_accommodation_link_description') }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="bg-white shadow-sm rounded-2xl">
                    <div class="p-6">
                        <h2 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('admin/settings.logo') }}</h2>

                        <!-- Current Logo Preview -->
                        <div class="mb-6">
                            <p class="text-sm font-medium text-gray-700 mb-2">{{ __('admin/settings.current_logo') }}</p>
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 bg-gray-50 flex items-center justify-center" style="min-height: 200px;">
                                ...
                                @else
                                    ...
                                    <p class="text-gray-400" id="logo-placeholder">{{ __('admin/settings.no_logo_uploaded') }}</p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <label class="flex-1 cursor-pointer">
                                <div class="border-2 border-gray-300 border-dashed rounded-xl p-4 text-center hover:border-blue-500 transition">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600" x-text="logoFileName || '{{ __('common.drag_drop_or_click') }}'"></p>
                                    <p class="mt-1 text-xs text-gray-500">{{ __('admin/settings.logo_requirements') }}</p>
                                </div>
                                <input
                                    type="file"
                                    name="logo"
                ...
                <div class="bg-white shadow-sm rounded-2xl">
                    <div class="p-6">
                        <h2 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('admin/settings.favicon') }}</h2>

                        <!-- Current Favicon Preview -->
                        <div class="mb-6">
                            <p class="text-sm font-medium text-gray-700 mb-2">{{ __('admin/settings.current_favicon') }}</p>
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 bg-gray-50 flex items-center justify-center" style="min-height: 200px;">
                                ...
                                @else
                                    ...
                                    <p class="text-gray-400" id="favicon-placeholder">{{ __('admin/settings.no_favicon_uploaded') }}</p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                {{ __('admin/settings.upload_favicon') }}
                            </label>
                            <label class="flex-1 cursor-pointer">
                                <div class="border-2 border-gray-300 border-dashed rounded-xl p-4 text-center hover:border-blue-500 transition">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600" x-text="faviconFileName || '{{ __('common.drag_drop_or_click') }}'"></p>
                                    <p class="mt-1 text-xs text-gray-500">{{ __('admin/settings.favicon_requirements') }}</p>
                                </div>
                                <input
                                    type="file"
                                    name="favicon"
            ...
            <div class="flex justify-center">
                ...
                >
                    ...
                    <span class="htmx-indicator">{{ __('admin/settings.updating') }}</span>
                    <span class="htmx-indicator-not">{{ __('admin/settings.update_all_settings') }}</span>
                </button>
            </div>
        </form>
    </div>
