                        ...
                        <div class="p-6">
                            <div>
                                <div class="mb-2 flex items-center justify-between">
                                    <h4 class="font-bold text-gray-900">{{ $activePeriod->name }}</h4>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-slate-50 rounded-xl hover:shadow-md transition-shadow duration-200 shadow-sm border border-blue-200">
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <a href="{{ $settings->contact_support_link }}" target="_blank" class="w-full inline-flex justify-center items-center gap-2 px-4 py-2 h-10 bg-blue-600 text-white font-medium rounded-lg shadow-sm hover:bg-blue-600/90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors text-sm">
