...
<div class="min-h-screen bg-gray-50">
    ...
    >
        ...
        <div id="loading-overlay" class="htmx-indicator fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center" style="z-index: 9999;">
