                ...
                <div class="py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <span
                                class="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-university-600 text-sm font-medium"
                                >2</span
                            >
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                      ...
                      <!-- Phone Field -->
                      <div class="relative"  x-data="{ form: { phone: '{{ old('phone', $application->phone ?? '') }}' } }">
                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required">Phone Number <span class="text-red-500 ml-1">*</span></label>
                    ...
                    <div class="space-y-6 py-6 border-t border-b border-slate-200">
                      <div class="flex items-center space-x-3">
                        ...
                        <h4 class="text-lg font-semibold text-slate-900">Permanent Address
                      ...
                      <div class="form-field">
                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required" for="permanent_address_street">Street Address<span class="text-red-500 ml-1">*</span></label>
                        <input 
                      ...
                      <!-- City -->
                      <div class="form-field">
                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required" for="permanent_address_city">City<span class="text-red-500 ml-1">*</span></label>
                        <input 
                      ...
                      <!-- State/Province -->
                      <div class="form-field">
                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label" for="permanent_address_state">State/Province</label>
                        <input 
                      ...
                      <!-- Country -->
                      <div class="form-field">
                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required">Country<span class="text-red-500 ml-1">*</span></label>
                        <select
                      ...
                      <!-- Postal Code -->
                      <div class="form-field">
                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required" for="permanent_address_postal_code">Postal/ZIP Code
                          <span class="text-red-500 ml-1">*</span>
                        </label>
                        <input 
