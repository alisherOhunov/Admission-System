<form hx-post="{{ route('applicant.application.contact') }}" hx-swap="outerHTML" hx-trigger="submit">
    <div x-data="contactForm()">
        @csrf
        <div class="bg-white shadow-sm rounded-lg px-6 pb-6">
            <div>
                    ...
                    <div class="space-y-6 pt-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mb-6">
                                Provide your current contact details and address information. This will be used for
                                all
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="relative">
                                ...
                                <input x-model="form.phone"
                                    ...
                                    name="phone" required placeholder="+(998)91 123-4567"
                        ...
                        <div class="space-y-6 py-6 border-t border-b border-slate-200">
                            ...
                            <div class="form-field">
                                <label
                                    class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required"
                                    for="permanent_address_street">
                                    Street Address<span class="text-red-500 ml-1">*</span>
                                </label>
                                <input x-model="form.permanent_address.street"
                                    ...
                                    :class="hasError('permanent_address.street') ? 'border-red-500 bg-red-50' :
                                        'border-input bg-background'"
                                    name="permanent_address[street]" id="permanent_address_street" required
                                    placeholder="123 Main Street, Apt 4B"
                                    @input="clearError('permanent_address.street')">

                                <template x-if="hasError('permanent_address.street')">
                                    <p class="mt-1 text-sm text-red-600"
                                        x-text="getError('permanent_address.street')">
                                    </p>
                                </template>
                            ...
                            <div class="form-field">
                                <label
                                    class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required"
                                    for="permanent_address_city">
                                    City<span class="text-red-500 ml-1">*</span>
                                </label>
                                <input x-model="form.permanent_address.city"
                                    class="flex h-10 w-full rounded-md border px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm form-input"
                                    :class="hasError('permanent_address.city') ? 'border-red-500 bg-red-50' :
                                        'border-input bg-background'"
                                    name="permanent_address[city]" id="permanent_address_city" required
                                    placeholder="New York" @input="clearError('permanent_address.city')">

                                <template x-if="hasError('permanent_address.city')">
                                    <p class="mt-1 text-sm text-red-600"
                                        x-text="getError('permanent_address.city')">
                                    </p>
                                </template>
                            ...
                            <div class="form-field">
                                <label
                                    ...
                                    for="permanent_address_state">
                                    State/Province
                                </label>
                                <input x-model="form.permanent_address.state"
                                    class="flex h-10 w-full rounded-md border px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm form-input"
                                    :class="hasError('permanent_address.state') ? 'border-red-500 bg-red-50' :
                                        'border-input bg-background'"
                                    name="permanent_address[state]" id="permanent_address_state"
                                    placeholder="New York" @input="clearError('permanent_address.state')">

                                <template x-if="hasError('permanent_address.state')">
                                    <p class="mt-1 text-sm text-red-600"
                                        x-text="getError('permanent_address.state')">
                                    </p>
                                </template>
                            ...
                            <div class="form-field">
                                ...
                                <select x-model="form.permanent_address.country" name="permanent_address[country]"
                                    required
                                    class="mt-1 flex h-10 w-full rounded-md border px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm form-input"
                                    :class="hasError('permanent_address.country') ? 'border-red-500 bg-red-50' :
                                        'border-input bg-background'"
                                    @change="clearError('permanent_address.country')">
                                    <option value="" class="text-muted-foreground">Select your country
                                    </option>
                                ...
                                <template x-if="hasError('permanent_address.country')">
                                    <p class="mt-1 text-sm text-red-600"
                                        x-text="getError('permanent_address.country')"></p>
                                </template>
                            ...
                            <div class="form-field">
                                <label
                                    class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 form-label form-label-required"
                                    for="permanent_address_postal_code">
                                    Postal/ZIP Code <span class="text-red-500 ml-1">*</span>
                                </label>
                                <input x-model="form.permanent_address.postal_code"
                                    class="flex h-10 w-full rounded-md border px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm form-input"
                                    :class="hasError('permanent_address.postal_code') ? 'border-red-500 bg-red-50' :
                                        'border-input bg-background'"
                                    name="permanent_address[postal_code]" id="permanent_address_postal_code"
                                ...
                                <template x-if="hasError('permanent_address.postal_code')">
                                    <p class="mt-1 text-sm text-red-600"
                                        x-text="getError('permanent_address.postal_code')"></p>
                                </template>
                                        ...
                                        <div class="flex items-start justify-between mb-3">
                                            <div class="flex-1">
                                                <div class="flex items-center space-x-2 mb-1">
                                                    ...
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">Optional</span>
                                                </div>
                ...
                <div class="flex items-center justify-between pt-8 border-t mt-8">
                    <button type="button"
                        class="cursor-not-allowed flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-400 bg-gray-100">
                    ...
                    <div class="flex items-center space-x-4">
                        <button type="button"
                            class="cursor-not-allowed disabled flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50">
                            <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
