            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between pt-8 pb-6 px-6 border-t mt-8">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button @click="currentStep = 5" type="button" class="flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
