                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                <svg id="eye-icon" class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-4 text-center space-y-2">
                        ...
                        <div class="text-xs space-y-1 text-gray-600">
                            <div><strong>Applicant:</strong> applicant@example.com</div>
                            <div><strong>Admin:</strong> admin@example.com</div>
                            <div><strong>Staff:</strong> staff@example.com</div>
                        </div>
                    </div>
                </div>
            </div>
