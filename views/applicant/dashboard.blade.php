        ...
        <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="text-blue-800">
                    ...
                    Deadline: <strong>{{ $currentPeriod->end_date->format('F j, Y') }}</strong>
                </div>
            </div>
        </div>
        @endif
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-1 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span>{{ $currentPeriod->start_date->format('M j, Y') }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span>End Date:</span>
                                    <span>{{ $currentPeriod->end_date->format('M j, Y') }}</span>
                                </div>
                            </div>
